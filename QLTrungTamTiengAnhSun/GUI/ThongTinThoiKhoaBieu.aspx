<%@ Page Title="" Language="C#" MasterPageFile="~/layout_Hv.Master" AutoEventWireup="true" CodeBehind="ThongTinThoiKhoaBieu.aspx.cs" Inherits="GUI.LichHocClient" %>
            ...
            <div class="box-inner" id="div_HocVien" runat="server">
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                     ...
                     <asp:Label ID="lb_idlopview" Visible="false" Text="rrrrshdsd" runat="server"></asp:Label>
                                
                    <asp:Repeater ID="Rep_View_Lop" Visible="false" runat="server" OnItemDataBound="Rep_View_Lop_ItemDataBound">
                        <ItemTemplate>
                            
                                   
                                        <asp:Label ID="lb_idLop" runat="server" Text='<%# Eval("IdLop") %>'></asp:Label>
