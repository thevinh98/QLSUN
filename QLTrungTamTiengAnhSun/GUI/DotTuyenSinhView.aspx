<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="DotTuyenSinhView.aspx.cs" Inherits="GUI.DotTuyenSinhView" %>
        ...
        <ContentTemplate>
            <%--    <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Cập Nhật Đợt tuyển Sinh</h2>
                </div>
                <div class="box-content1" style="margin: 5px 5px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:LinkButton ID="LinkButton3" runat="server" class="btn btn-success" OnClick="Update_Click"><i class="glyphicon glyphicon-refresh "></i> Cập Nhật</asp:LinkButton>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Đợt Tuyển Sinh</h2>
                </div>
                <div class="box-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-2">
                             <asp:LinkButton ID="LinkButton3" runat="server" class="btn btn-success" ><i class="glyphicon glyphicon-plus-sign"></i> Xuất Excel</asp:LinkButton></a>
                        </div>
                    </div>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tên Đợt Tuyển Sinh">
                                <ItemTemplate>
                                    <asp:Label ID="lblName1" runat="server" Text='<%# Eval("TenDotTuyenSinh") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Thời Gian">
                                <ItemTemplate>
                                    <asp:Label ID="lblName2" runat="server" Text='<%# DateTime.Parse(Eval("ThoiGian").ToString()).ToString("dd-MM-yyyy" +"</br>" +"hh:mm tt") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Trạng Thái">
                                <ItemTemplate>
                                    <asp:Label ID="lblName22" runat="server" Text='<%# Eval("TrangThai") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Nội Dung">
                                <ItemTemplate>
                                    <asp:Label ID="lblName21" runat="server" Text='<%# CuttingString( Eval("NoiDung"), 30) %>' ToolTip='<%#  Eval("NoiDung") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="LinkButton4" runat="server" class="btn btn-info" CommandArgument='<%# Eval("IdDotTuyenSinh") %>' OnClick="Edit_Click"><i class="glyphicon glyphicon-edit icon-white"></i> Sửa</asp:LinkButton>
                                    <asp:LinkButton ID="btn_Delete" runat="server" class="btn btn-danger" CommandArgument='<%# Eval("IdDotTuyenSinh") %>' OnClick="Delete_Click" OnClientClick="return confirm('Bạn Chắc Chắn Muốn Xóa!')"><i class="glyphicon glyphicon-trash icon-white"></i> Xóa</asp:LinkButton>
                                </ItemTemplate>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="box-content1" style="margin: 5px 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="comment">Tên Đợt Tuyển Sinh:</label>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:TextBox TextMode="DateTimeLocal" class="form-control" ID="Txt_ThoiGian" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:DropDownList Size="1" ID="DropDown_TrangThai" runat="server" class="form-control">
                                                ...
                                                <asp:ListItem>Sắp Tuyển Sinh</asp:ListItem>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <asp:LinkButton ID="LinkButton5" runat="server" class="btn btn-warning" OnClick="Back_Click"><i class="glyphicon glyphicon glyphicon-remove"></i> Thoát</asp:LinkButton>
                                    </div>
