...
namespace GUI
{
    public partial class DanhSachThongBaoGVHomNay : BasePage
    {
        ...
        protected void BindListView()
        {
            ...
            List<ThongBaoGiaoVien> lst = ThongBaoGiaoVienBLL.GetListThongBaoGiaoVienhomnay(time);
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                List<ThongBaoGiaoVien> lst = ThongBaoGiaoVienBLL.SearchListhomnay(time,a);
                _pgsource.DataSource = lst;
                _pgsource.AllowPaging = true;
                // Number of items to be displayed in the Repeater
                _pgsource.PageSize = int.Parse(lb_op.Text);
