<%@ Page Title="" Language="C#" MasterPageFile="~/layout_Hv.Master" AutoEventWireup="true" CodeBehind="ThongTinThongBao.aspx.cs" Inherits="GUI.ThongTinThongBao" %>
            ...
            <div class="box-inner" runat="server">
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                           <asp:Label ID="lb_idlopview" Visible="false"  runat="server"></asp:Label>
