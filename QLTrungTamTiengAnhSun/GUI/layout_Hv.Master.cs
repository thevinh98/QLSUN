...
namespace GUI
{
    public partial class layout_Hv : System.Web.UI.MasterPage
    {
        ...
        protected void BindListView()
        {
            if (Session["Currentuser"] != null)
            {
                ...
                if (user != null)
                {
                    ...
                    List<HocVien> lst = HocVienBLL.GetListThongTinHocVien(id);
            ...
            if (Session["Currentuser"] != null)
            {
                ...
                else
                {
                    ...
                    if (user != null)
                    {
                        ...
                        NguoiDungHocVien updatend = NguoiDungHocVienBLL.GwtById(id);
                        ...
                        if (updatend != null)
                        {
                            ...
                            updatend = NguoiDungHocVienBLL.UpDateFile(updatend);
