...
{
    public partial class DiemDanhGV :BasePage
    {
        ...
        protected void BindListView()
        {
            ...
            List<Lop> lst = LopBLL.GetListLop_DM();
        ...
        protected void DanhSach_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("/StyleGV/DanhSachHocVienLop.aspx?Id={0}", btn.CommandArgument));
            }
        ...
        protected void LichHoc_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                Response.Redirect(string.Format("/StyleGV/LichHocLop.aspx?Id={0}", btn.CommandArgument));
            }
        ...
        protected void DiemDanh_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                Response.Redirect(string.Format("/StyleGV/DiemDanhLop.aspx?Id={0}", btn.CommandArgument));
            }
