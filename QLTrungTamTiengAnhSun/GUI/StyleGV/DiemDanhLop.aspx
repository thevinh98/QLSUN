<%@ Page Title="" Language="C#" MasterPageFile="~/StyleGV/layout_giaovien.Master" AutoEventWireup="true" CodeBehind="DiemDanhLop.aspx.cs" Inherits="GUI.StyleGV.DiemDanhLop" %>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                        &times;</button>
                                    <h4 class="modal-title" id="ModalTitle1">Cập Nhật Điểm Danh</h4>
