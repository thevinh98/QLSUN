...
namespace GUI
{
    public partial class LayoutADM : System.Web.UI.MasterPage
    {
            ...
            if (Session["Currentuser"] != null)
            {
                ...
                else
                {
                    ...
                    if (user != null)
                    {
                        ...
                        NguoiDungADM updatend = NguoiDungADMBLL.GwtById(id);
                        ...
                        if (updatend != null)
                        {
                            ...
                            updatend = NguoiDungADMBLL.UpDateFile(updatend);
            ...
            try
            {
                if (Session["Currentuser"] != null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        List<NguoiDungADM> nd = NguoiDungADMBLL.GetListNguoiDungADMView(id);
                        rep_nd.DataSource = nd;
                        rep_nd.DataBind();
                    }
                }
            }
