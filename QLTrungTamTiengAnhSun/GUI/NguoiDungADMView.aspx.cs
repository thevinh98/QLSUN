...
namespace GUI
{
    public partial class NguoiDungADMView : BasePage
    {
        ...
        {
            List<NhanVien> lstvaitro = NhanVienBLL.GetListNhanVien();
        ...
        protected void BindListView()
        {
            ...
            List<NguoiDungADM> lst = NguoiDungADMBLL.GetListNguoiDungADM();
        ...
        protected void Edit_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                ...
                NguoiDungADM view = NguoiDungADMBLL.GwtById(btn.CommandArgument);
                if (view != null)
                {
                  ...
                  if(view.TrangThai==true)
                    ...
                    if (Dropdow_gv.Items.FindByValue(view.IdNhanVien.ToString()) != null)
                        Dropdow_gv.SelectedValue = view.IdNhanVien.ToString();
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                NguoiDungADMBLL.DeleteFile(btn.CommandArgument);
                Gr_View.DataBind();
            }
            if (string.IsNullOrEmpty(txt_search.Text))
            {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            List<NguoiDungADM> lst = NguoiDungADMBLL.SearchList(a);
            _pgsource.DataSource = lst;
            _pgsource.AllowPaging = true;
            // Number of items to be displayed in the Repeater
            _pgsource.PageSize = int.Parse(lb_op.Text);
        ...
        protected void Update_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(lb_id.Text))
            {
                ...
                NguoiDungADM update = NguoiDungADMBLL.GwtById(id);
                if (update != null)
                {
                    string idnv = Dropdow_gv.SelectedItem.Value;
                    update.IdNhanVien = Guid.Parse(idnv);
                    ...
                    update = NguoiDungADMBLL.UpDateFile(update);
                }
            ...
            else
            {
                ...
                try
                {
                    NguoiDungADM insert = new NguoiDungADM();
                    insert.Id = Guid.NewGuid();
                    string idnv = Dropdow_gv.SelectedItem.Value;
                    insert.IdNhanVien = Guid.Parse(idnv);
                    ...
                    insert = NguoiDungADMBLL.InsertFile(insert);
        ...
        {
            Response.Redirect("NguoiDungADMView.aspx");
