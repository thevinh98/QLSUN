<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="DongHocPhi.aspx.cs" Inherits="GUI.HocPhiView" %>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <FooterStyle Font-Bold="True" />
                           ...
                           <asp:TemplateField HeaderText=" Số Tiền Thanh Toán">
                                <ItemTemplate>
                                    <asp:Label ID="lblName1" runat="server" Text='<%# Eval("TienThanhToan") +" VND" %>'></asp:Label>
                                </ItemTemplate>
                                <FooterStyle Font-Bold="True" />
                            </asp:TemplateField>
