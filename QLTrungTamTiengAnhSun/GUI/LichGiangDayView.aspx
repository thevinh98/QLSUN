<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="LichGiangDayView.aspx.cs" Inherits="GUI.LichGiangDayView" %>
        ...
        <ContentTemplate>--%>
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i></i> Lịch Giảng Dạy Lớp Học </h2>
                </div>
                <div class="box-content1" style="margin: 5px 5px">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:DropDownList Size="1" ID="dropdow_Lop" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="dropdow_Lop_SelectedIndexChanged">
                            </asp:DropDownList>
            ...
            <hr />
            <div class="box-inner" id="div_lich" runat="server">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Lịch Giảng Dạy</h2>
                </div>
