...
namespace GUI
{
    public partial class NguoiDungHocVienView : BasePage
    {
        ...
        private void LoadDDLHHocVien()
        {
            List<HocVien> lstvaitro = HocVienBLL.GetListHocVien();
        ...
        protected void BindListView()
        {
            ...
            List<NguoiDungHocVien> lst = NguoiDungHocVienBLL.GetListNguoiDungHocVien();
        ...
        protected void Edit_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                ...
                NguoiDungHocVien view = NguoiDungHocVienBLL.GwtById(btn.CommandArgument);
                if (view != null)
                {
                    ...
                    if (Dropdow_hv.Items.FindByValue(view.IdHocVien.ToString()) != null)
                        Dropdow_hv.SelectedValue = view.IdHocVien.ToString();
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
            ...
            if (btn != null && !string.IsNullOrEmpty(btn.CommandArgument))
            {
                NguoiDungHocVienBLL.DeleteFile(btn.CommandArgument);
                Gr_View.DataBind();
            }
            if (string.IsNullOrEmpty(txt_search.Text))
            {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            List<NguoiDungHocVien> lst = NguoiDungHocVienBLL.SearchList(a);
            _pgsource.DataSource = lst;
            _pgsource.AllowPaging = true;
            // Number of items to be displayed in the Repeater
            _pgsource.PageSize = int.Parse(lb_op.Text);
        ...
        protected void Update_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(lb_id.Text))
            {
                ...
                NguoiDungHocVien update = NguoiDungHocVienBLL.GwtById(id);
                if (update != null)
                {
                    string idhv = Dropdow_hv.SelectedItem.Value;
                    update.IdHocVien = Guid.Parse(idhv);
                    ...
                    update = NguoiDungHocVienBLL.UpDateFile(update);
                }
            ...
            else
            {
                ...
                try
                {
                    NguoiDungHocVien insert = new NguoiDungHocVien();
                    insert.Id = Guid.NewGuid();
                    string idhv = Dropdow_hv.SelectedItem.Value;
                    insert.IdHocVien = Guid.Parse(idhv);
                    ...
                    insert = NguoiDungHocVienBLL.InsertFile(insert);
        ...
        {
            Response.Redirect("NguoiDungHocVienView.aspx");
