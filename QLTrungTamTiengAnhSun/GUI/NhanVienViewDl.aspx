<%@ Page Title="" Language="C#"  EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="NhanVienViewDl.aspx.cs" Inherits="GUI.NhanVienViewDl" %>
        ...
        <ContentTemplate>--%>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Nhân Viên</h2>
                </div>
                    ...
                    <asp:Panel runat="server" ID="DivTable">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Năm Sinh">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName2" runat="server" Text='<%# DateTime.Parse(Eval("NamSinh").ToString()).ToString("dd-MM-yyyy") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Giới Tính">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName213" runat="server" Text='<%# Eval("GioiTinh") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="SDT">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName22" runat="server" Text='<%# Eval("SDT") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Email">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName21" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Địa Chỉ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName24" runat="server" Text='<%# Eval("DiaChi") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Ngày Vào Làm">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName243" runat="server" Text='<%# DateTime.Parse(Eval("NgayVaoLam").ToString()).ToString("dd-MM-yyyy") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Chức Vụ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName2312" runat="server" Text='<%# Eval("TenChucVu") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Lương">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName231" runat="server" Text='<%# Eval("LuongThang") +  "VND" %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Trạng Thái">
                                    <ItemTemplate>
                                        <asp:Label ID="lblName221" runat="server" Text='<%# Eval("TrangThai") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="LinkButton4" runat="server" class="btn btn-info" CommandArgument='<%# Eval("Id") %>' OnClick="Edit_Click"><i class="glyphicon glyphicon-edit icon-white"></i> Sửa</asp:LinkButton>
                                    </ItemTemplate>
