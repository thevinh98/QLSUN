<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="NhapHocView.aspx.cs" Inherits="GUI.NhapHocView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="box-inner" id="div_HocVien" runat="server">
        <div class="box-header well" data-original-title="">
            <h2><i class="glyphicon glyphicon-user"></i>Học Viên</h2>
        </div>
            ...
            <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:LinkButton ID="btn_Edit" runat="server" class="btn btn-info" CommandArgument='<%# Eval("IdNhapHoc") %>' OnClick="Edit_Click"><i class="glyphicon glyphicon-edit icon-white"></i> Sửa</asp:LinkButton>
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="btn_Delete" runat="server" class="btn btn-danger" CommandArgument='<%# Eval("IdNhapHoc") %>' OnClick="Delete_Click" OnClientClick="return confirm('Bạn Chắc Chắn Muốn Xóa!')"><i class="glyphicon glyphicon-trash icon-white"></i> Xóa</asp:LinkButton>
                        </ItemTemplate>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="box-content1" style="margin: 5px 5px">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <asp:GridView AutoGenerateColumns="False" ID="Gr_HocVien"
                                        class="table table-striped table-bordered bootstrap-datatable datatable responsive" runat="server">
                                        <Columns>
