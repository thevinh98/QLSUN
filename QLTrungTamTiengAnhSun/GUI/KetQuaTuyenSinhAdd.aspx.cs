...
namespace GUI
{
    public partial class KetQuaTuyenSinhAdd : BasePage
    {
        ...
        {
            Response.Redirect("ChucVuAdd.aspx");
        ...
        protected void Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("/ChucVuAdd.aspx?Id={0}", btn.CommandArgument));
            }
        }
