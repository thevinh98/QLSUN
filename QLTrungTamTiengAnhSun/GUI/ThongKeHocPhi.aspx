<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="ThongKeHocPhi.aspx.cs" Inherits="GUI.ThongKeHocPhi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" ChildrenAsTriggers="true" runat="server">
        <ContentTemplate>
                ...
                <div class="box-content1" style="margin: 5px 5px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:LinkButton ID="btn_Search" runat="server" class="btn btn-warning " OnClick="ThongKe_HocPhi_Click"><i class="glyphicon glyphicon-search icon-white"> Thống Kê</i></asp:LinkButton>
                        </div>
            ...
            <br />
            <div class="box-inner" id="div_ThongKeHocPhi"  visible="false" runat="server">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Thống Kê Học Phí</h2>
                </div>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tổng Tiền ">
                                <ItemTemplate>
                                    <asp:Label ID="lblName213" runat="server" Text='<%# Eval("DaDong") %>'></asp:Label>
                                </ItemTemplate>
