<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="PhongHocView.aspx.cs" Inherits="GUI.PhongHocView" %>
        ...
        <ContentTemplate>
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Phòng Học</h2>
                </div>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Ghi Chú">
                                <ItemTemplate>
                                    <asp:Label ID="lblName2" runat="server" Text='<%# Eval("GhiChu") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Trạng Thái">
                                <ItemTemplate>
                                    <asp:Label ID="lblName213" runat="server" Text='<%# Eval("TrangThai") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_Edit" runat="server" class="btn btn-info" CommandArgument='<%# Eval("IdPhongHoc") %>' OnClick="Edit_Click"><i class="glyphicon glyphicon-edit icon-white"></i> Sửa</asp:LinkButton>
                                    <asp:LinkButton ID="btn_Delete" runat="server" class="btn btn-danger" CommandArgument='<%# Eval("IdPhongHoc") %>' OnClick="Delete_Click" OnClientClick="return confirm('Bạn Chắc Chắn Muốn Xóa!')"><i class="glyphicon glyphicon-trash icon-white"></i> Xóa</asp:LinkButton>
                                </ItemTemplate>
                    ...
                    <ContentTemplate>
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="box-header well" data-original-title="">
                                    <h2><i class="glyphicon glyphicon-user"></i>Cập Nhật Phòng Học</h2>
                                ...
                                <div class="box-content1" style="margin: 5px 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <label for="comment">Tên Phòng học:</label>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:DropDownList Size="1" ID="DropDown_TrangThai" runat="server" class="form-control">
                                                <asp:ListItem>Hoạt Động</asp:ListItem>
                                                <asp:ListItem>Không Hoạt Động</asp:ListItem>
