<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="NguoiDungADMView.aspx.cs" Inherits="GUI.NguoiDungADMView" %>
        ...
        <ContentTemplate>
            ...
            <div class="box-inner" runat="server">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Tài Khoản ADMin</h2>
                </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="box-header well" data-original-title="">
                                    <h2><i class="glyphicon glyphicon-user"></i>Cập Nhật Tài Khoản ADMIN</h2>
                                ...
                                <div class="box-content1" style="margin: 5px 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="comment">Nhân Viên:</label>
