<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="DotKiemTraView.aspx.cs" Inherits="GUI.DotKiemTraView" %>
        ...
        <ContentTemplate>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Đợt Kiểm Tra</h2>
                </div>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tên Đợt Tuyển Sinh">
                                <ItemTemplate>
                                    <asp:Label ID="lblName1" runat="server" Text='<%# Eval("Ten") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Ghi Chú">
                                <ItemTemplate>
                                    <asp:Label ID="lblName21" runat="server" Text='<%# CuttingString( Eval("GhiChu"), 30) %>' ToolTip='<%#  Eval("GhiChu") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="LinkButton4" runat="server" class="btn btn-info" CommandArgument='<%# Eval("IdDotKiemTra") %>' OnClick="Edit_Click"><i class="glyphicon glyphicon-edit icon-white"></i> Sửa</asp:LinkButton>
                                    <asp:LinkButton ID="btn_Delete" runat="server" class="btn btn-danger" CommandArgument='<%# Eval("IdDotKiemTra") %>' OnClick="Delete_Click" OnClientClick="return confirm('Bạn Chắc Chắn Muốn Xóa!')"><i class="glyphicon glyphicon-trash icon-white"></i> Xóa</asp:LinkButton>
                                </ItemTemplate>
                    ...
                    <ContentTemplate>
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="box-header well" data-original-title="">
                                    <h2><i class="glyphicon glyphicon-user"></i>Cập Nhật Đợt Kiểm Tra</h2>
                                ...
                                <div class="box-content1" style="margin: 5px 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label for="comment">Tên Đợt Kiểm Tra:</label>
                                            <asp:TextBox class="form-control" ID="txt_tendotkiemtra" runat="server"></asp:TextBox>
                                            <asp:Label ID="lb_tendotkiemtra" runat="server" ForeColor="Red" Visible="false" class="control"></asp:Label>
                                        </div>
                                        <div class="col-sm-6">
                                        </div>
