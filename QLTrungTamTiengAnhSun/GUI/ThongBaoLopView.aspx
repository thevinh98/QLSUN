<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="ThongBaoLopView.aspx.cs" Inherits="GUI.ThongBaoLopView" %>
        ...
        <ContentTemplate>--%>
            ...
            <div class="box-inner" runat="server">
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-success" OnClick="Btn_Add"><i class="glyphicon glyphicon-plus-sign"></i> Thêm Mới</asp:LinkButton>
                    ...
                    <ContentTemplate>
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="box-header well" data-original-title="">
                                    <h2><i class="glyphicon glyphicon-user"></i>Cập Nhật Thông Báo Lớp</h2>
                                ...
                                <div class="box-content1" style="margin: 5px 5px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <asp:TextBox class="form-control" ID="txt__tieude" runat="server"></asp:TextBox>
