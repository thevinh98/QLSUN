<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="DanhSachHocPhiHomNay.aspx.cs" Inherits="GUI.DanhSachHocPhiHomNay" %>
                    ...
                    <asp:GridView AutoGenerateColumns="False" ID="Gr_View"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Học Phí">
                                <ItemTemplate>
                                    <asp:Label ID="lblName223" runat="server" Text='<%# Eval("HocPhiLop") %>'></asp:Label>
                                </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblName21" runat="server" Text='<%# Eval("TienDaDong") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterStyle Font-Bold="True" />
                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="Học Phí Còn Lại">
                                <ItemTemplate>
                                    <asp:Label ID="lblName233" runat="server" Text='<%# Eval("TienConLai") %>'></asp:Label>
                                </ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText=" Số Tiền Thanh Toán">
                                <ItemTemplate>
                                    <asp:Label ID="lblName1" runat="server" Text='<%# Eval("TienThanhToan") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Học Phí Giảm Trừ">
                                <ItemTemplate>
                                    <asp:Label ID="lblName243" runat="server" Text='<%# Eval("GiamTru") %>'></asp:Label>
                                </ItemTemplate>

                                <FooterStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Ngày Đóng">
                                <ItemTemplate>
                                    <asp:Label ID="lblName23" runat="server" Text='<%# DateTime.Parse(Eval("ThoiGianDong").ToString()).ToString("dd-MM-yyyy") %>'></asp:Label>
                                </ItemTemplate>
