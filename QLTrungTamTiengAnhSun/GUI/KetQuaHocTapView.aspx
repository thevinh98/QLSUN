<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="KetQuaHocTapView.aspx.cs" Inherits="GUI.KetQuaHocTapView" %>
        ...
        <ContentTemplate>--%>
          ...
          <div class="box-inner" id="div_HocVien" runat="server" >
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>Kết Quả Học Tập</h2>
                </div>
