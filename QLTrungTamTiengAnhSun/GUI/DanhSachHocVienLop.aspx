<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/LayoutADM.Master" AutoEventWireup="true" CodeBehind="DanhSachHocVienLop.aspx.cs" Inherits="GUI.DanhSachHocVienLop" %>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="box-content1" style="margin: 5px 5px">
                            ...
                            <asp:GridView AutoGenerateColumns="False" ID="Gr_TT"
                                class="table table-striped table-bordered bootstrap-datatable datatable responsive" runat="server">
