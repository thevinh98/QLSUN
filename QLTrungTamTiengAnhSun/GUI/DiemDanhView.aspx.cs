...
namespace GUI
{
    public partial class DiemDanhView : BasePage
    {
        ...
        {
            Response.Redirect("DiemDanhAdd.aspx");
        ...
        protected void BindListView()
        {
            ...
            List<DiemDanh> lst = DiemDanhBLL.GetListDiemDanh();
        ...
        protected void Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("/DiemDanhAdd.aspx?Id={0}", btn.CommandArgument));
            }
        }
