...
namespace GUI
{
    public partial class LichGiangDayView : BasePage
    {
        ...
        {
            Response.Redirect("LichGiangDayAdd.aspx");
        ...
        protected void BindListView()
        {
            ...
            List<LichGiangDay> lst = LichGiangDayBLL.GetListLichGiangDay();
        ...
        protected void Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("/LichGiangDayAdd.aspx?Id={0}", btn.CommandArgument));
            }
        }
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            List<LichGiangDay> lst = LichGiangDayBLL.SearchList(a);
            _pgsource.DataSource = lst;
            _pgsource.AllowPaging = true;
            // Number of items to be displayed in the Repeater
            _pgsource.PageSize = int.Parse(lb_op.Text);
        ...
        protected void dropdow_Lop_SelectedIndexChanged(object sender, EventArgs e)
        {
            div_lich.Visible = true;
            var id = dropdow_Lop.Items[dropdow_Lop.SelectedIndex].Value;

            List<LichGiangDay> lst = LichGiangDayBLL.GetListLichHoc(id);
            _pgsource.DataSource = lst;
            _pgsource.AllowPaging = true;
            // Number of items to be displayed in the Repeater
            _pgsource.PageSize = int.Parse(lb_op.Text);
